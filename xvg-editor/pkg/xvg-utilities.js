// FILE: xvg-utilities.js - REFACTORED TO ES MODULE
'use strict';
...
export function validateCanvas(value, name) {
...
export function sizeCanvasToDisplaySize(c, logicalW, logicalH) {
  try {
...
console.log('✅ xvg-utilities ready as ES Module');
