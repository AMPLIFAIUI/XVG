...
## Overview
This document outlines the core logic requirements for implementing the XVG specification in the main project components (xvg-desktop, xvg-web, xvg-wasm, xvg-py, xvg-core).
...
### Rust (xvg-core, xvg-desktop, xvg-wasm)
